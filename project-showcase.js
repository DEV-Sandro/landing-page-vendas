...
function renderProject(index, animate = true) {
  ...
  const update = () => {
    ...
    if (mobileImage) { mobileImage.src = project.image; mobileImage.alt = `Projeto ${project.title} em celular`; }
